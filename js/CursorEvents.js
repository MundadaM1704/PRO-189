AFRAME.registerComponent("cursor-listener", {
    ...
    update: function () {
      ...
      //check if the infocards plane already has comic text info child entity
    ...
    handleMouseEnterEvents: function () {
      ...
      this.el.addEventListener("mouseenter", () => {
        ...
        if (booksId.includes(id)) {
          ...
          booksContainer.setAttribute("cursor-listener", {
            selectedItemId: id,
          });
    ...
    handleMouseClickEvents: function () {
      ...
      this.el.addEventListener("click", () => {
        ...
        //check the selected item to set the "info-cards" component on the plane
        if (selectedItemId) {
          fadeBackgroundEl.setAttribute("visible", true);
          fadeBackgroundEl.setAttribute("info-card", {
